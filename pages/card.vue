  ...
  <div>
    ...
    <nav class="flex items-center justify-between flex-wrap bg-gray-800 p-6">
      <div class="flex items-center flex-shrink-0 text-white mr-6">
        <span class="font-bold text-xl">Code Nx</span>
      </div>
      ...
      <div class="w-full block flex-grow sm:flex sm:items-center sm:w-auto">
        <div class="text-sm sm:flex-grow">
          ...
          <a
            ...
            class="block mt-4 sm:inline-block sm:mt-0 text-teal-200 hover:text-white mr-4"
          >Networking</a>
          <a href="#" class="block mt-4 sm:inline-block sm:mt-0 text-teal-200 hover:text-white">Blog</a>
        </div>
        <div>
          <a
            href="#"
    ...
    <!-- CARD COMPONENT -->
    <div class="relative max-w-sm mx-auto flex p-6 bg-white rounded-lg shadow-xl">
      <EyeIcon class="absolute right-0" />
    ...
    <div class="container mt-5 mx-auto px-2">
      ...
      <div class="md:flex">
        <div class="relative flex-1 text-gray-700 text-center bg-gray-400 px-5 py-5 m-2 rounded">
          <plus-icon size="1.5x" class="custom-class absolute right-0"></plus-icon>
          <div class="lg:flex lg:items-center">
            <div class="lg:flex-shrink-0">
              <img class="rounded-lg lg:w-64" src="https://i.ibb.co/mJJNkTJ/img2.jpg" alt />
            </div>
            <div class="mt-4 lg:mt-0 lg:ml-6">
              <div class="uppercase tracking-wide text-sm text-indigo-600 font-bold">Networking</div>
              <a
                href="#"
...
<script>
import {EyeIcon, PlusIcon} from 'vue-feather-icons'
export default {
    components:{EyeIcon,
    PlusIcon
    }
