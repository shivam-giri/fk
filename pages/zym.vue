  ...
  <div>
          ...
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            <li class="flex items-center">
              ...
              >
                ...
                <span class="lg:hidden inline-block ml-2">Profile</span>
              </a>
            </li>
          </ul>
        </div>
    ...
    <main>
     ...
     "
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div>
                <h1 class="text-white font-semibold text-5xl">
                  Feel The
                  <span class="text-orange-500">Power</span>
                </h1>
                ...
                <ul class="list-none mt-6">
                  <li class="py-2">
                    <div class="flex items-center">
                      ...
                      <div>
                        <h4 class="text-xl">The latest & greatest gym equipment</h4>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="flex items-center">
                      ...
                      <div>
                        <h4 class="text-xl">5-inch, quality foam floor padding</h4>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-4/12 lg:mb-0 mb-12 px-4" data-aos="flip-right">
              <div class="px-6">
                ...
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Will Smith Mishra</h5>
                  <p
                    class="mt-1 text-sm text-gray-500 uppercase font-semibold"
                  >Neighborhood Watchman</p>
                </div>
              </div>
            </div>
            <!-- Card 2 -->
            <div class="w-full md:w-4/12 lg:mb-0 mb-12 px-4" data-aos="flip-right">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Shree Devi Sharma</h5>
                  <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">Cupcake Smasher</p>
                </div>
              </div>
            </div>
            <!-- Card 3 -->
            <div class="w-full md:w-4/12 lg:mb-0 mb-12 px-4" data-aos="flip-right">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Devi Prasad bahu</h5>
                  <p
                    class="mt-1 text-sm text-gray-500 uppercase font-semibold"
                  >Double Whoopass With Cheese</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="rounded-full w-48 h-4">aaaa</div>
      <!-- Contact Form -->
            ...
            <div class="w-full lg:w-6/12 px-4">
              ...
              >
                <div class="flex-auto p-5 lg:p-10 bg-orange-500 text-white">
                  ...
                  <p
                    class="leading-relaxed mt-1 mb-4"
                  ...
                  <div class="relative w-full mb-3">
                    <label class="block uppercase text-xs font-bold mb-2" for="email">Email</label>
                    <input
                      type="email"
                      class="px-3 py-3 placeholder-gray-400 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
                      placeholder="Email"
                  ...
                  <div class="relative w-full mb-3">
                    <label class="block uppercase text-xs font-bold mb-2" for="message">Message</label>
                    <textarea
                      rows="4"
                      cols="80"
                      class="px-3 py-3 placeholder-gray-400 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
      ...
      <div class="container mx-auto px-4">
          ...
          <div class="w-full lg:w-6/12 px-4">
            ...
            <div class="mt-6">
              <button
                ...
                type="button"
              >
                <i class="flex fab fa-twitter text-orange-500"></i>
              </button>
              <button
                class="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3"
                type="button"
              >
                <i class="flex fab fa-facebook-square text-orange-500"></i>
              </button>
              <button
        ...
        <div class="flex flex-wrap items-center md:justify-between justify-center">
          <div class="w-full md:w-4/12 px-4 mx-auto text-center">
            <div class="text-sm text-gray-600 font-semibold py-1">Copyright © The Power Room</div>
          </div>
        </div>
      </div>
    </footer>
